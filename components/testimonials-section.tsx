...
const testimonials = [
  {
    quote:
      "Hoa tươi Hoàng Vũ đã biến đám cưới của chúng tôi thành thiên đường hoa. Mỗi tác phẩm đều vượt xa mọi tưởng tượng của tôi.",
    author: "Thanh Mai",
  ...
  {
    quote:
      "Năm ngoái chúng tôi chuyển sang dùng hoa của Hoa tươi Hoàng Vũ cho văn phòng. Chất lượng ổn định, thiết kế luôn mới mẻ và khách hàng liên tục khen ngợi.",
    author: "Minh Tuấn",
